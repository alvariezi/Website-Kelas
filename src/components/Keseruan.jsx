    ...
    <div className="flex flex-col items-center justify-center md:mt-10 mb-10 max-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-around w-full">
        <div className="flex flex-col items-center">
          ...
          <span className="text-[31px] font-semibold text-[#9A9A9A]">
            Kekompakan
          </span>
        </div>
        ...
        <div className="flex flex-col items-center">
          <span className="text-[55px] font-bold">{RandomKelas}</span>
          <span className="text-[31px] font-semibold text-[#9A9A9A]">
            Jumlah Siswa
          </span>
        </div>
      </div>
      <div className="lg:w-[1238.5px] h-[1px] bg-[#D4D4D4] mt-10"></div>
    </div>
  );
};
